...
public class TargetController {
    ...
    public String saveTargets(RedirectAttributes redirectAttributes,
                              @ModelAttribute TargetRequest targetRequest){

        saveTargetValuesUseCase.saveTargetValues(targetRequest);
        redirectAttributes.addAttribute("username", targetRequest.getUsername());
