...
public class SectionController {
    ...
    @GetMapping(Route.FINANCE)
    public String displayFinancePanel(Model model){
        model.addAttribute(ACTIVE_PAGE, Route.VIEW_FINANCE);
        return Route.VIEW_FINANCE;
    }

    @GetMapping(Route.INVESTMENT)
    public String displayInvestmentPanel(Model model){
        model.addAttribute(ACTIVE_PAGE, Route.VIEW_INVESTMENT);
        return Route.VIEW_INVESTMENT;
    }
}
