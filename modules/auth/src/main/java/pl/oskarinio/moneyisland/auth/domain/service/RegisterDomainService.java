...
public class RegisterDomainService {
    ...
    public RegisterDomainService(UserRepository userRepository, UserManagement userManagement, PasswordEncoderPort passwordEncoderPort, Clock clock, long refreshSeconds) {
